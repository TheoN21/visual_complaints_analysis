...
pie(table(dataTN$Sexf), main = 'Sex', col = c('floralwhite','lightblue1'))    
pie(table(dataTN$Eduf), main = 'Level of Education',clockwise = TRUE, col = c('floralwhite','lightblue1','deepskyblue'))     
pie(table(dataTN$Neuf), main = 'Visit to Neurologist', col = c('floralwhite','lightblue1'))     
pie(table(dataTN$Psyf), main = 'Visit to Psychologist', col = c('floralwhite','lightblue1'))
