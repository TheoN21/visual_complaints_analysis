...
pie(table(dataTN$Sexf), main = 'Sex', col = c('white','lightblue1'))    
pie(table(dataTN$Eduf), main = 'Level of Education',clockwise = TRUE, col = c('white','lightblue1','deepskyblue'))     
pie(table(dataTN$Neuf), main = 'Visit to Neurologist', col = c('white','lightblue1'))     
pie(table(dataTN$Psyf), main = 'Visit to Psychologist', col = c('white','lightblue1'))
