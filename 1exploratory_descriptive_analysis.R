...
pie(table(dataTN$Sexf), main = 'Sex')    
pie(table(dataTN$Eduf), main = 'Level of Education')     
pie(table(dataTN$Neuf), main = 'Visit to Neurologist')     
pie(table(dataTN$Psyf), main = 'Visit to Psychologist')
